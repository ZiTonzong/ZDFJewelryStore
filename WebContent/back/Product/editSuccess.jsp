...
<table class="table table-bordered table-hover m10">
    ...
    <tr>
        ...
        <td><a target="_blank" href="/ZDFJewelryStore_Demo/${product.productImagePath }?
					productid=${product.productId }">
					<img src="/ZDFJewelryStore_Demo/${product.productImagePath }" 
...
$(function () { 
	$('#backid').click(function(){
		window.location.href="${pageContext.request.contextPath}/listProduct?pageNos=${pageNos}";
	 });
});
