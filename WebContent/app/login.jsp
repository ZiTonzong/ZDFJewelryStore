...
<script type="text/javascript">
	$(function() {
		...
		$("#btn").click(function(){
			...
			var url = "/ZDFJewelryStore_Demo/handleLogin";
		...
		<form action="       " method="post">
			...
			<p style="padding: 30px 0px 10px; position: relative;">
				<span class="u_logo"></span> <input class="ipt" type="text"
					placeholder="用户名" value="" name="username" autofocus="autofocus" id="login_username">
			</p>
			<p style="position: relative;">
				<span class="p_logo"></span> 
				<input class="ipt" type="password" placeholder="密码" value="" name="password" id="login_passwd">
			</p>
			 <span><font id="errorMsg" style="font-style:'楷书';font-size:15px;color: red"></font></span> 
