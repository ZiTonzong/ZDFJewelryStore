...
<title>${requestScope.criteriaProductName}的搜索结果-ZDF</title>
		...
		<div class="wrap">
			<div class="section group">
				<div class="cont span_2_of_3" style="width: 100%" >
					<h2 class="head"><h2 class="head">“${requestScope.criteriaProductName}” 的搜索结果...</h2></h2>
                ...
                <c:choose>
                  ...
                  <a href="handleAllProducts?method=showAllProducts&pageNo=${pager.totalPage}">尾页</a>
