...
/**
 * Servlet implementation class HandleBackAllOrders
 */
@WebServlet(urlPatterns = "/handleBackAllOrders")
public class HandleBackAllOrders extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public HandleBackAllOrders() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// TODO Auto-generated method stub
		       ...
		       // if(pageNo)
				// 每页显示8个商品
				PageUtil pageUtil = page_dao.getPageOrders(pageNo, 8);
				...
				request.getRequestDispatcher("/back/order.jsp").forward(request, response);
	}
